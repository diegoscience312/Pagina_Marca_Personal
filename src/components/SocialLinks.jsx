...
export default function SocialLinks({ instagram, tiktok, linkedin, instagramUrl, tiktokUrl, linkedinUrl }) {
  return (
    <div className="flex gap-2 mt-2">
      {instagram && (
        <motion.a
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium text-white/70 hover:text-white transition-colors duration-200 group shadow-sm"
